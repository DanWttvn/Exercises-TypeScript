...
var Member = /** @class */ (function (_super) {
    ...
    function Member(id, name, email, age) {
        var _this = _super.call(this, name, email, age) // needs super(params of the class extended from). this is doing the this.= for us
         || this;
        _this.id = id;
        return _this;
    }
...
var joanna = new User("Joanna", "jdo@gmail.com", 45);
...
joanna.register();
var mika = new Member(1, "Mika", "mik@gmail.com", 78);
mika.payInvoice();
